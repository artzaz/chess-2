...
namespace SrcChess2.Core {
    ...
    internal sealed class ChessGameBoardAdaptor(ChessBoard chessBoard, Dispatcher dispatcher) : IGameBoard<Move> {
        /// <summary>Translation table</summary>
        private static TransTable?         s_transTable;
        /// <summary>Chess board</summary>
        private readonly ChessBoard m_chessBoard = chessBoard;
