...
namespace GenericSearchEngine {
    ...
    public class SearchEngineSetting(SearchOption  searchOption,
                                     ThreadingMode threadingMode,
                                     int           searchDepth,
                                     int           timeOutInSec,
                                     RandomMode    randomMode,
                                     int           transTableEntryCount) : ICloneable {
        ...
        /// Search option
        /// </summary>
        public SearchOption SearchOption { get; set; } = searchOption;

        /// <summary>
        /// Threading option
        /// </summary>
        public ThreadingMode ThreadingMode { get; set; } = threadingMode;
        ...
        /// </summary>
        public int TimeOutInSec { get; set; } = timeOutInSec;

        /// <summary>Random mode</summary>
        public RandomMode RandomMode { get; set; } = randomMode;

        /// <summary>
        /// Numbers of entry in the translation table if any
        /// </summary>
        public int TransTableEntryCount { get; set; } = transTableEntryCount;
